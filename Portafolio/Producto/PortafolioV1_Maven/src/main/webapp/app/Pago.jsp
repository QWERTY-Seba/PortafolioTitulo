...
<html>
    ...
    <body class="bg-light">
        ...
        <main role="main" > 
            ...
            <div class="container-md mx-0 px-0 mx-md-auto px-md-auto py-4 mt-4 bg-white">
                <div class="row ">
                    <p class="fs-1 text-center">Pago de Pedido</p>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr class="p-2">
                                            <td class="p-2">
                                                <div >
                                                    <img src="Static/Imagenes/Frutas/${Pedido.subasta.produccion.getRutaProducto()}" style="width: 90px;">
                                                </div>
                                            </td>

                                            <td>${Pedido.subasta.produccion.getProducto()} tamaño ${Pedido.subasta.produccion.calidad}</td>
                                            <td>$${Pedido.subasta.precio_por_kg}</td>
                                            <td>${Pedido.cantidad}</td>
                                            <td>$${Pedido.cantidad * Pedido.subasta.precio_por_kg}</td>
                                        </tr>
                                    </tbody></table>
    ...
    return actions.order.create({
      ...
      purchase_units: [{
        ...
        items : [{
            ...
            name : 'pedido',
            description : '${Pedido.cantidad.toString()}kg ${subasta.produccion.getProducto()} ${subasta.produccion.calidad} ',
  ...
  onApprove: function(data, actions) {
       ...
       {id_order : orderData.id,
        ...
        id_pedido : orderData.purchase_units[0].items[0].sku}; 
